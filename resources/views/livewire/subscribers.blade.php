<div class="p-6 bg-white border-b border-gray-200">
    ...
    <div class="px-8">
        <x-input type="text" class="float-right w-1/3 pl-8 mb-4 border border-gray-300 rounded-lg" placeholder="Search"
            wire:model='search'>
        </x-input>
        ...
        @else
        <table class="w-full">
            <thead class="text-indigo-300 border-b-2 border-gray-600">
                <tr>
            ...
            <tbody>
                ...
                <tr class="text-sm text-indigo-900 border-b border-gray-400">
                    ...
                    <td class="px-6 py-4">{{ optional($subscriber->email_verified_at)->diffForHumans() ??
                        'Never' }}</td>
                    <td class="px-6 py-4">
